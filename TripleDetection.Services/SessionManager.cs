...
{
    /// <summary>
    /// User session manager (global static singleton)
    /// Before login is implemented, defaults to "system" user
    /// </summary>
    public static class SessionManager
    {
        public static int CurrentUserId { get; private set; } = 0;        // 0=system
